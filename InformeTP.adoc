...
de compra y demás el simple hecho de llenar una tabla con datos de forma más sencilla. Por su contraparte, el uso
de BoltDB lo vemos más orientado a una base de datos pequeña donde lo que se premie es una organización y visión
