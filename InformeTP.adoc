...
Por último, en caso de no elegir la opción de salida válida, se mostrará un mensaje
...
MOTIVOS:
1. Tarjeta no valida o no vigente = 0
2. Codigo de seguridad invalido = 1
3. Plazo de vigencia expirado = 2
4. La tarjeta se encuentra suspendida = 3
5. Supera limite de tarjeta = 4
